// BumpPHSpecular.fx
// Parallax Mapping using heightMap
...
void BumpPHSpecularVS(float3 Pos : POSITION0, 
...
float4 BumpPHSpecularPS(float2 Tex : TEXCOORD0, 
				...
				float3 posW : TEXCOORD4) : COLOR0
{
	...
	Tex += (parallaxHeightScale * (parallaxHeightOffset + tex2D(BumpS, Tex).r)) * parallaxDir.xy;
...
technique BumpPHSpecular
{
	pass P0
	{
		VertexShader = compile vs_3_0 BumpPHSpecularVS();
		PixelShader = compile ps_3_0 BumpPHSpecularPS();		
	}
}
