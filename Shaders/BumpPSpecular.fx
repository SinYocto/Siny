// BumpPSpecular.fx
// Parallax Mapping using normalMap and heightMap
...
void BumpPSpecularVS(float3 Pos : POSITION0, 
...
float4 BumpPSpecularPS(float2 Tex : TEXCOORD0, 
				...
				float3 posW : TEXCOORD4) : COLOR0
{
	...
	Tex += (parallaxHeightScale * (parallaxHeightOffset + tex2D(HeightS, Tex).r)) * parallaxDir.xy;
...
technique BumpPSpecular
{
	pass P0
	{
		VertexShader = compile vs_3_0 BumpPSpecularVS();
		PixelShader = compile ps_3_0 BumpPSpecularPS();		
	}
}
